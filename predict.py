...
parser.add_argument("--no_labels", action="store_true", help="The dataset does not contain labels (unlabeled fields should have underscores). When using this flag, automatic evaluation will be avoided.")
...
for dataIdx in range(0, len(args.file_paths), 2):
    ...
    predict_with_paths(model, input_path, output_path, args.dataset, args.batch_size, args.raw_text, device, args.conn, args.sep, args.threshold, args.no_labels)
